...
public class HPostSwornStatementRequest extends HRequest<Documentation> {

    private static final String PATH = RestConstants.HOST + RestConstants.POST_SWORN_STATEMENT_SERVICE;
    private String mResource;

    public HPostSwornStatementRequest(String resource, Response.Listener<Documentation> listener, Response.ErrorListener errorListener) {
