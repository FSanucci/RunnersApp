...
import com.app.runners.utils.SnackBarHelper;
...
public class AddPersonalInfoActivity extends BaseActivity {
    ...
    private void sendNote(){
        ...
        if(!AppController.getInstance().isNetworkAvailable()) {
            DialogHelper.showNoInternetErrorMessage(AddPersonalInfoActivity.this,null);
            return;
        }
        ...
        UserController.getInstance().postComment(note, new Response.Listener<ArrayList<RunnerComment>>() {
            ...
            public void onResponse(ArrayList<RunnerComment> response) {
                showProgress(false);
                Toast.makeText(getApplicationContext(), AddPersonalInfoActivity.this.getString(R.string.personal_info_add_success), Toast.LENGTH_SHORT).show();
                finish();
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                showProgress(false);
                DialogHelper.showMessage(AddPersonalInfoActivity.this,R.string.error,R.string.personal_info_add_error2);
            }
        });
    }
