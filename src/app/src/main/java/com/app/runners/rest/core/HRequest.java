...
public abstract class HRequest<T> extends JsonRequest<T> {
    ...
    protected VolleyError parseNetworkError(VolleyError volleyError) {
        if(volleyError.networkResponse != null && (volleyError.networkResponse.statusCode==403 || volleyError.networkResponse.statusCode==401) && volleyError.toString().contains("AuthFailureError")){
    ...
    public String toString() {
        ...
        String hMethod = "";
        switch (mHttpMethod){
            case 0: hMethod = "GET"; break;
            case 1: hMethod = "POST"; break;
            case 2: hMethod = "PUT"; break;
            case 7: hMethod = "PATH"; break;
            case 3: hMethod = "DELETE"; break;
        }
